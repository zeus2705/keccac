...
./keccak -224 $test_file -256 $test_file -384 $test_file -512 $test_file> Test/resultcksum
...
./keccak -224 $test_phrase -256 $test_phrase -384 $test_phrase -512 $test_phrase > Test/resultstr;
